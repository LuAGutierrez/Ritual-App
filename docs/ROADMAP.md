...
- [x] **Categoría preferida "pegajosa"**: se elige en chips en el hub `/juegos`, aplica a todos los juegos que arranquen después (sessionStorage, `lib/categoriaPreferida.ts`), con indicador visible y opción de limpiarla
