...
const MP_BACK_URL = Deno.env.get("MP_BACK_URL") || "https://rituales.vercel.app/precios";
const backUrlWithParam = MP_BACK_URL.includes("?") ? MP_BACK_URL : `${MP_BACK_URL}?success=1`;
